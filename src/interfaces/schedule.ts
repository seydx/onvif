...
import type { Description, Name, Time } from './onvif.js'
import type { DataEntity, PositiveInteger } from './types.js'
...
export type GetScheduleState = {
  /** Token of schedule instance to get ScheduleState. */
  token?: ReferenceToken
}
export type GetScheduleStateResponse = {
  /** ScheduleState item. */
  scheduleState?: ScheduleState
}
export type GetScheduleInfo = {
  /** Tokens of ScheduleInfo items to get. */
  token?: ReferenceToken[]
}
export type GetScheduleInfoResponse = {
  /** List of ScheduleInfo items. */
  scheduleInfo?: ScheduleInfo[]
}
export type GetScheduleInfoList = {
  /**
...
export type GetScheduleInfoListResponse = {
  /**
...
export type GetSpecialDayGroupInfoResponse = {
  /** List of SpecialDayGroupInfo items. */
  specialDayGroupInfo?: SpecialDayGroupInfo[]
}
export type GetSpecialDayGroupInfoList = {
  /**
...
export type GetSpecialDayGroupInfoListResponse = {
  /**
   * StartReference to use in next call to get the following items.
   * If absent, no more items to get.
   */
...
export type GetSpecialDayGroups = {
  /** Tokens of the SpecialDayGroup items to get */
  token?: ReferenceToken[]
}
export type GetSpecialDayGroupsResponse = {
  /** List of SpecialDayGroup items. */
  specialDayGroup?: SpecialDayGroup[]
}
export type GetSpecialDayGroupList = {
  /**
   * Maximum number of entries to return. If not specified, less than
...
export type GetSpecialDayGroupListResponse = {
  /**
...
export type CreateSpecialDayGroup = {
  /** The special day group to create. */
  specialDayGroup?: SpecialDayGroup
}
export type CreateSpecialDayGroupResponse = {
  /** The token of created special day group. */
  token?: ReferenceToken
}
export type SetSpecialDayGroup = {
